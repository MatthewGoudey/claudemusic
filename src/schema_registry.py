...
SCHEMA = {
    "endpoints": [
        ...
        },
        {
            ...
            "method": "GET",
            "description": "Cross-reference upcoming shows against listening history — ranked by relevance score (log(listens) * track breadth * recency * proximity). The key endpoint for taste-based show recommendations. Supports festival lineup matching.",
            "params": {
                "start_date": {"type": "ISO date string", "required": False, "default": "today"},
