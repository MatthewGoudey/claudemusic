    ...
    "endpoints": [
        ...
        },
        {
            ...
            "params": {
                ...
                "artist": {"type": "string", "required": False, "description": "Fuzzy match artist name"},
                "tag": {"type": "string", "required": False, "description": "Filter by Last.fm tag (fuzzy match, e.g. 'shoegaze', 'hip-hop')"},
                "limit": {"type": "int", "required": False, "default": 50, "max": 1000},
        ...
        },
        {
            ...
            "params": {
                ...
                "subgenre": {"type": "string", "required": False, "description": "Filter by subgenre (case-insensitive)"},
                "tier": {"type": "string", "required": False, "enum": ["essential", "important", "deep"]},
                "tag": {"type": "string", "required": False, "description": "Filter by Last.fm tag (fuzzy match)"},
        ...
        # ---- Album Checklist ----
        {
            "route": "/api/checklist",
            "method": "GET",
            "description": "Browse unified album checklist (Rolling Stone 500, 1001 Albums, AOTY, canonical, manual). Shows listen stats, session counts, completion, and source tags per album. Priority sort ranks albums highly ranked on multiple lists first.",
            "params": {
                "source": {"type": "string", "required": False, "enum": ["rolling_stone_500", "1001_albums", "aoty", "canonical", "manual"]},
                "heard": {"type": "string", "required": False, "enum": ["true", "false"]},
                "artist": {"type": "string", "required": False, "description": "Fuzzy match on artist name"},
                "tag": {"type": "string", "required": False, "description": "Filter by Last.fm tag (fuzzy match, e.g. 'indie rock', 'post-punk'). Use /api/checklist/tags to see available tags."},
                "year_min": {"type": "int", "required": False},
                "year_max": {"type": "int", "required": False},
                "sort": {"type": "string", "required": False, "default": "priority", "enum": ["priority", "year", "artist", "recent"]},
        ...
        {
            "route": "/api/checklist/gaps",
            "method": "GET",
            "description": "Unheard checklist albums sorted by priority (highly ranked on multiple lists first). Use for 'what should I listen to next' recommendations.",
            "params": {
                "source": {"type": "string", "required": False, "enum": ["rolling_stone_500", "1001_albums", "aoty", "canonical", "manual"]},
                "artist": {"type": "string", "required": False},
                "tag": {"type": "string", "required": False, "description": "Filter by Last.fm tag (fuzzy match). Use /api/checklist/tags to see available tags."},
                "year_min": {"type": "int", "required": False},
                "year_max": {"type": "int", "required": False},
                "limit": {"type": "int", "required": False, "default": 50, "max": 500},
                "offset": {"type": "int", "required": False, "default": 0},
        ...
        {
            "route": "/api/checklist/tags",
            "method": "GET",
            "description": "Most common Last.fm tags across checklist album artists. Use to discover valid tag names for the ?tag= filter on checklist and canonical endpoints.",
            "params": {
                "source": {"type": "string", "required": False, "enum": ["rolling_stone_500", "1001_albums", "aoty", "canonical", "manual"], "description": "Limit to tags from one source list"},
                "limit": {"type": "int", "required": False, "default": 50, "max": 200},
            },
            "auth": True,
        },
        {
            "route": "/api/checklist/stats",
            "method": "GET",
            "description": "Checklist summary: total albums, heard/unheard per source, overlap counts.",
            "params": {},
            "auth": True,
        },
        {
            "route": "/api/checklist",
            "method": "POST",
            "description": "Add albums to checklist manually (by Claude or user).",
            "body": {"albums": [{"artist": "str", "album": "str", "year": "int?"}], "source": "manual"},
            "auth": True,
        },
        {
            "route": "/api/checklist/{album_id}",
            "method": "DELETE",
            "description": "Remove album from checklist (cascades to sources + matches).",
            "params": {"album_id": {"type": "int", "required": True, "location": "path"}},
            "auth": True,
        },
        {
            "route": "/api/checklist/matches/refresh",
            "method": "POST",
            "description": "Re-match all checklist albums to listen events using two-pass normalized matching. Run after adding new albums or new listen data.",
            "params": {},
            "auth": True,
        },
    ]
